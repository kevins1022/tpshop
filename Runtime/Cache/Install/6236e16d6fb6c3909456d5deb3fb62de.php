 ...
 defined('SAE_MYSQL_HOST_M') or define('SAE_MYSQL_HOST_M', '127.0.0.1'); defined('SAE_MYSQL_HOST_M') or define('SAE_MYSQL_PORT', '3306'); ?>
    ...
    <form action="/install.php?s=/Install/step2.html" method="post" target="_self">
        <div class="create-database">
            ...
            <div>
                <input type="text" name="db[]" value="yershop_">
        ...
        <div class="create-database">
            <h2>创始人帐号信息</h2>
            <div>
                <input type="text" name="admin[]" value="yershop">
                <span>用户名</span>
            </div>
            <div>
    ...
    <a class="btn-an blue" href="<?php echo U('Install/step1');?>">上一步</a>
    <a id="submit" type="button" class="btn-an orange" onclick="$('form').submit();return false;">下一步</a>
