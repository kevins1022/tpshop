    ...
    <div class="data-table">
        <table>
            ...
            <tr>
                ...
                <td>
                    <?php
 $good = M("Document")->find($value['good_id']); echo $good['title']; ?>
                </td>
                <td>
                    <?php
 $user = M("member")->find($value['uid']); echo $user['nickname']; ?>
                </td>
                ...
                <td>
                    <?php
 echo $value['sum']; echo $value['type']==1?'积分': '元'; ?>
                </td>
                <td><?php echo date("Y-m-d: H:i:s", $value['addtime']); ?></td>
                <td>
                    <?php
 $map['uid'] = $value['uid']; $add = M("userShopAdd")->where($map)->find(); echo "电话".$add['phone']." 地址".$add['address']." 真实姓名：".$add['truename']; ?>
                </td>
            </tr>
            <?php endforeach; ?>
            </tbody>
