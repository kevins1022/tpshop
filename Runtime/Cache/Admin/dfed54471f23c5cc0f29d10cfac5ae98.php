...
<body>
	...
	<div class="main-title">
		<h2><?php echo isset($info['id'])?'编辑':'新增';?>商品  分类</h2>
	</div>
	<div class="tab-wrap">
		...
		<div class="tab-content">
			<form action="<?php echo U();?>" method="post" class="form-horizontal">
				...
				<div id="tab1" class="tab-pane in tab1">
					...
					<div class="form-item">
						<label class="item-label">
							分类属性<span class="check-tips">（ 小于等于1-商品分类 1-前台菜单调用，0-前台菜单不调用，大于1-文章分类 2-售后 3-公告）</span>
						</label>
						<div class="controls">
							<input type="text" name="ismenu" class="text input-large" value="<?php echo ((isset($info["ismenu"]) && ($info["ismenu"] !== ""))?($info["ismenu"]):'1'); ?>">
						</div>
					</div>
					<div class="form-item">
						<label class="item-label">
					...
					<div class="form-item">
						<label class="item-label">列表绑定文档模型<span class="check-tips">（列表支持发布的文档模型，必填，单选）</span></label>
						<div class="controls">
							<?php $_result=get_modelListGoods();if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><label class="checkbox">
				...
				<div id="tab2" class="tab-pane tab2">
					...
					<div class="form-item">
						...
						<div class="controls">
							<input type="text" name="list_row" class="text input-small" value="<?php echo ((isset($info["list_row"]) && ($info["list_row"] !== ""))?($info["list_row"]):30); ?>">
						</div>
					</div>
...
<div class="form-item">
						<label class="item-label">扩展字段</label>
						<div class="controls">
						
								<input type="text" name="extend" class="text input-large" value="<?php echo ((isset($info["extend"]) && ($info["extend"] !== ""))?($info["extend"]):''); ?>">
