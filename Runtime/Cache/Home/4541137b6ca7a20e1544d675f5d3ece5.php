        ...
        <div class="list_ticket">
            <ul>
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "暂时没有数据" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><li>
                    <img src="<?php echo (get_cover($list["cover_id"],'path')); ?>" width="480" height="192">
                    <a href="<?php echo U('User/jfChange');?>"><div class="btn">去兑换</div></a>
                    <div class="tit"><?php echo ($list["title"]); ?></div>
                    <div class="point"><?php echo ($list["jifen"]); ?>分<span></span></div>
