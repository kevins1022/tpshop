...
<a href="#header4" id="detail_tab" name="__tab_detail_b2c" rel="header4"class="">商品问答(<?php echo (get_message_count($info["id"])); ?>条)</a>
<a href="#header5" id="detail_tab" name="__tab_detail_b2c" rel="header5" class="">商品包装</a>
</ul>
</div>
